...
#define WMTitleColorSelected [UIColor redColor]
//[UIColor colorWithRed:168.0/255.0 green:20.0/255.0 blue:4/255.0 alpha:1]
#define WMTitleColorNormal   [UIColor grayColor]
...
//  导航菜单栏的高度
static CGFloat const WMMenuHeight        = 40.0f;
//  导航菜单栏每个item的宽度
static CGFloat const WMMenuItemWidth     = 80.0f;
