...
{
    MyAddView * adView = [MyAddView adScrollViewWithFrame:frame imageLinkURL:imageLinkURL placeHoderImageName:nil  pageControlShowStyle:PageControlShowStyle];
    return adView;
}
...
+ (id)adScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSArray *)imageLinkURL placeHoderImageName:(NSString *)imageName pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    MyAddView * adView = [[MyAddView alloc]initWithFrame:frame];
