...
@interface MoreColumnViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation MoreColumnViewController
...
//    NSString *url = [NSString stringWithFormat:kColumnUrl,self.pid,20*(self.page-1),20*self.page];
...
-(void)createRefreshView {
    ...
    [weakSelf.tableView addRefreshHeaderViewWithAniViewClass:[JHRefreshCommonAniView class] beginRefresh:^{
        ...
        NSString *url = [NSString stringWithFormat:kColumnUrl,weakSelf.pid,20*(weakSelf.page-1),20*weakSelf.page];
