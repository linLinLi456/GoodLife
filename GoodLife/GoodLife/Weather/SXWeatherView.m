...
- (void)layoutSubviews{
    ...
    [self addBtnWithTitle:@"登录" icon:@"202" color:[UIColor redColor] index:1];
    [self addBtnWithTitle:@"离线" icon:@"203" color:[UIColor colorWithRed:213/255.0 green:22/255.0 blue:71/255.0 alpha:1] index:2];
    [self addBtnWithTitle:@"签到" icon:@"205" color:[UIColor colorWithRed:58/255.0 green:153/255.0 blue:208/255.0 alpha:1] index:3];
    [self addBtnWithTitle:@"扫一扫" icon:@"204" color:[UIColor colorWithRed:70/255.0 green:95/255.0 blue:176/255.0 alpha:1] index:4];
    [self addBtnWithTitle:@"我的" icon:@"201" color:[UIColor colorWithRed:80/255.0 green:192/255.0 blue:70/255.0 alpha:1] index:5];
...
- (void)addBtnWithTitle:(NSString *)title icon:(NSString *)icon color:(UIColor *)color index:(int)index{
    ...
    btn.tag = index;
    [btn addTarget:self action:@selector(toOtherVC:) forControlEvents:UIControlEventTouchUpInside];
    btn.width = w-40;
...
-(void)toOtherVC:(UIButton *)button {
